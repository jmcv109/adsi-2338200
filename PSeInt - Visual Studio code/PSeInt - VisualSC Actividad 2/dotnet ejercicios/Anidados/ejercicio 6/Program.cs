...
namespace dotnet_ejercicios
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double  capital, equipo_computo, prestamo, incentivos, Mobiliario, Presupuesto, insumos;
            ...
            if (capital < 0)
            {
                ...
                equipo_computo = 500000;
                Mobiliario = 200000;
                insumos = (prestamo - (equipo_computo + Mobiliario)) / 2;
                incentivos = (prestamo - (equipo_computo + Mobiliario)) / 2;
            }
            ...
            Console.WriteLine("El dinero (" + Presupuesto + ") tendra la siguiente reparticion:\n ");
            Console.WriteLine("Prestamo          = " + prestamo);
            Console.WriteLine("Equipo de computo = " + equipo_computo);
